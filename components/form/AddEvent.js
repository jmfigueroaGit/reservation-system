...
export default function AddEvent() {
	...
	return (
		<form className="w-screen " onSubmit={submitHandler}>
			<div className="container mx-auto w-3/5  bg-[#2C325A] m-10 rounded-lg drop-shadow-md">
			...
			<div className="container flex justify-end w-3/5 m-10 mx-auto">
				<button
					className=" w-1/4 p-4 m-2 font-bold text-white bg-[#24C4CD] rounded-lg shadow hover:bg-[#21b2b9] focus:shadow-outline focus:outline-none"
					type="submit"
					disabled={loading ? true : false}
				>
					{loading ? <ButtonLoader /> : `Save ${'&'} Continue`}
				</button>
			</div>
		</form>
	);
